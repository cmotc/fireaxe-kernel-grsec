...
#define TI_status 4 /* offsetof(struct thread_info, status)	# */
#define TI_addr_limit 16 /* offsetof(struct thread_info, addr_limit)	# */
#define TI_lowest_stack 24 /* offsetof(struct thread_info, lowest_stack)	# */
#define TI_task_thread_sp0 -1528 /* offsetof(struct task_struct, thread.sp0) - offsetof(struct task_struct, tinfo)	# */
